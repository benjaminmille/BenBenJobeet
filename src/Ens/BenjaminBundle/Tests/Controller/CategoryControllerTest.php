<?php
// src/Ens/BenjaminBundle/Tests/Controller/CategoryControllerTest.php
...
class CategoryControllerTest extends WebTestCase
{
    public function testShow()
    {
        ...
        $this->assertEquals('Ens\BenjaminBundle\Controller\CategoryController::showAction', $client->getRequest()->attributes->get('_controller'));
